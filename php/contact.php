...
if (filter_var($_REQUEST['contact_email'], FILTER_VALIDATE_EMAIL)):
  $subject = 'email from website'; // Subject of your email

  // Receiver email address
  $to = 'wandilemagagula@gmail.com';  //Change the email address by yours
  ...
  // $header .= 'Cc:  ' . 'wandilemagagula@gmail.com' . "\r\n";
  // $header .= 'Bcc:  ' . 'wamgtech@gmail.com' . "\r\n";
